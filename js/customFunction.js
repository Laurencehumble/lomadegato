...
function editResident(that){
    ...
    res_province 	= $(that).attr('data-res_province');
    res_city 	= $(that).attr('data-res_city');
    res_house 	= $(that).attr('data-res_house');
    res_street 	= $(that).attr('data-res_street');
    res_barangay 	= $(that).attr('data-res_barangay');
    ...
    $('#email').val(email);
    $('#number').val(number);
    $('#res_province').text(res_province);
    $('#res_city').text(res_city);
    $('#res_house').text(res_house);
    $('#res_street').text(res_street);
    $('#res_barangay').text(res_barangay);
    $('#occupation').val(occu);
